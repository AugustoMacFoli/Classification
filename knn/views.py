...
def knn(request):
    return render(request, 'knn/knn.html')
...
def knn_play(request):
    ...
    classifier = sklearn.neighbors.KNeighborsClassifier(n_neighbors = 3, metric = 'minkowski', p = 2)
    ...
    return render(request, 'knn/knn_play.html', context)