...
import numpy, matplotlib.pyplot, pandas, matplotlib.colors
import sklearn.metrics, sklearn.preprocessing, sklearn.model_selection, sklearn.linear_model

def logistic_regression(request):
    return render(request, 'logistic_regression/logistic_regression.html')

def logistic_regression_play(request):
    ...
    return render(request, 'logistic_regression/logistic_regression_play.html', context)