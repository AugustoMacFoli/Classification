...
def kernel_svm(request):
    return render(request, 'kernel_svm/kernel_svm.html')

def kernel_svm_play(request):
    ...
    return render(request, 'kernel_svm/kernel_svm_play.html', context)